...
#define DEFAULT_CAPTURE_STILL_WIDTH		(3200)
#define DEFAULT_CAPTURE_STILL_HEIGHT		(2400)
#define DEFAULT_CAPTURE_STILL_CROP_WIDTH	(3200)
#define DEFAULT_CAPTURE_STILL_CROP_HEIGHT	(1800)
...
#define DEFAULT_3H7_PREVIEW_WIDTH		(1920)	/* sensor margin : 16 */
#define DEFAULT_3H7_PREVIEW_HEIGHT		(1080)	/* sensor margin : 12 */
#define DEFAULT_3H7_VIDEO_WIDTH			(1920)
#define DEFAULT_3H7_VIDEO_HEIGHT		(1080)
#define DEFAULT_3H7_STILLSHOT_WIDTH		(3200)
#define DEFAULT_3H7_STILLSHOT_HEIGHT		(2400)
