...
#define IS_ERROR_WAIT_STREAM_ON_NOT_DONE	(IS_ERROR_SCALERP_FRAME_END_NOT_DONE+1)
#define IS_ERROR_WAIT_STREAM_OFF_NOT_DONE	(IS_ERROR_WAIT_STREAM_ON_NOT_DONE+1)
