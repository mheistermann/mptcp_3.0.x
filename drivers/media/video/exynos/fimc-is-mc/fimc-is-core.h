...
#define S5K3H7_ACTUATOR_NAME_AK7343
...
#define MAX_ISP_INTERNAL_BUF_WIDTH		(3200)  /* 4808 in HW */
#define MAX_ISP_INTERNAL_BUF_HEIGHT		(2400)  /* 3356 in HW */
#define SIZE_ISP_INTERNAL_BUF \
	(MAX_ISP_INTERNAL_BUF_WIDTH * MAX_ISP_INTERNAL_BUF_HEIGHT * 3)

#define MAX_ODC_INTERNAL_BUF_WIDTH		(2400)  /* 4808 in HW */
#define MAX_ODC_INTERNAL_BUF_HEIGHT		(1360)  /* 3356 in HW */
