...
static struct s3c_gpio_chip exynos5_gpio_common_4bit[] = {
	{
		...
		.base   = (S5P_VA_GPIO2 + 0x3C0),
		.config	= &gpio_cfg_noint,
		.chip	= {
			.base	= EXYNOS5_GPY7(0),
			.ngpio	= EXYNOS5_GPIO_Y7_NR,
			.label	= "GPY7",
		},
	}, {
