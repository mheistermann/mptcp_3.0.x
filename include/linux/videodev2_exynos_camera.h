...
enum v4l2_image_effect {
	V4L2_IMAGE_EFFECT_NORMAL,
	V4L2_IMAGE_EFFECT_MONOCHROME,
	V4L2_IMAGE_EFFECT_NEGATIVE_MONO,
	V4L2_IMAGE_EFFECT_NEGATIVE_COLOR,
	V4L2_IMAGE_EFFECT_SEPIA,
	V4L2_IMAGE_EFFECT_AQUA,
	V4L2_IMAGE_EFFECT_REDDISH,
	V4L2_IMAGE_EFFECT_BLUISH,
	V4L2_IMAGE_EFFECT_GREENISH,
	V4L2_IMAGE_EFFECT_SKETCH,
	V4L2_IMAGE_EFFECT_EMBOSS_COLOR,
	V4L2_IMAGE_EFFECT_EMBOSS_MONO,
