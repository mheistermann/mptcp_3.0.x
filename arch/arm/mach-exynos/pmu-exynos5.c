...
void __iomem *list_disable_pmu_reg[] = {
...
static int __init exynos5_pmu_init(void)
{
	...
	/*
	 * Follow register should be set with 0x0
	 */
	for (i = 0 ; i < ARRAY_SIZE(list_disable_pmu_reg) ; i++)
		__raw_writel(0x0, list_disable_pmu_reg[i]);
