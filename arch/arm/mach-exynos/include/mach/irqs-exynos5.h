...
#define IRQ_SYSMMU_MFC_R_0	COMBINER_IRQ(6, 2)
#define IRQ_SYSMMU_MFC_R_1	COMBINER_IRQ(6, 3)
...
#define IRQ_SYSMMU_MFC_L_0	COMBINER_IRQ(8, 5)
#define IRQ_SYSMMU_MFC_L_1	COMBINER_IRQ(8, 6)
